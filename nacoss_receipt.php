...
require_once ('includes/function.php');
  ...
  include_once('includes/receipt_header.php');
    ...
    //detect nass or nacoss 
       ...
       $due_amount = sort_old_new_std_NACOSS($id);
...
<?php
     ...
     $depart = sort_old_new_std_NACOSS($id);
          $depart = $user_data['detect'];
          
        //return pool of valid payment data eg s/n, refno
         $payment = get_data_by_depart($id,$depart);
         //amount paid
...
<a href="#"><img src="images/banner1.jpeg" width="48" height="33" 
style="border:none;
float:left;"></a>NACOSS MAUTECH, DUES REGISTRATION SPECIMEN </div>
...
<table class="reference" style="width:60%">
	<tbody>
            <tr>
		<td>SERIAL NUMBER</td>
		  <td><?php echo uppercase($payment[9]) ?></td>
	</tr>
	<tr>
		<td>REF NUMBER</td>
		<td><?php echo uppercase($payment[7]) ?></td>
	</tr>
	<tr>
		<td>DATE OF PAYMENT</td>
	<td><?php echo uppercase($payment[8]) ?></td>
	</tr>
	<tr>
		<td>AMOUNT PAID</td>
