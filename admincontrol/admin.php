...
if (isset($_POST["emailnamecheck"])) {
    ...
    $sql = "SELECT id FROM tbladmin WHERE email ='$email' LIMIT 1";
...
if(isset($_POST["e"])){
	...
	// -------------------------------------------
	$sql = "SELECT id FROM tbladmin WHERE email='$e' LIMIT 1";
    $query = mysqli_query($link, $sql); 
...
$sql = "INSERT INTO tbladmin (email,password,firstname,lastname,ip,passcode)       
